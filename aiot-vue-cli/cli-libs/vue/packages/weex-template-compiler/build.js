...
var inBrowser = false; //typeof window !== 'undefined'
...
//   return _isServer
// }
var isServerRendering = function () { return false; };
...
function observe (value, asRootData) {
  ...
  if (hasOwn(value, '__ob__') && value.__ob__ instanceof Observer) {
    ...
    !value._isVue && (canObserverHook === undefined )
  ) {
