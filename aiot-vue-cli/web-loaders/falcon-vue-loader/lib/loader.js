...
// dep loaders
var styleLoaderPath = normalize.dep('falcon-style-loader')
...
// var hasBuble = false; //!!tryRequire('buble-loader')
...
module.exports = function (content) {
  ...
  if (parts.styles.length) {
    ...
    parts.styles.forEach(function (style, i) {
      ...
      var hasVueStyleLoader = requireString.indexOf('falcon-style-loader') > -1
