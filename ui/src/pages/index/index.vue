...
.home { width: 580px; height: 234px; padding: 12px 16px; background-color: @ink; }
.home-header { width: 580px; height: 45px; flex-direction: row; align-items: center; justify-content: space-between; }
...
.header-note { width: 280px; color: @muted; font-size: 11px; line-height: 16px; text-align: right; }
.home-content { width: 580px; height: 185px; flex-direction: row; }
.recent-column { width: 195px; height: 185px; }
.section-label { height: 22px; color: @muted; font-size: 11px; line-height: 17px; }
.recent-empty { width: 160px; height: 58px; padding: 18px 14px; border-radius: 13px; background-color: @panel; }
...
.mini-recent { width: 165px; height: 22px; margin-top: 8px; padding: 8px 10px; border-radius: 10px; background-color: @panel; flex-direction: row; justify-content: space-between; }
...
.action-grid { width: 370px; height: 185px; flex-direction: row; flex-wrap: wrap; }
.tile-left { margin-left: 10px; }
.tile-top { margin-top: 8px; }
.tile-left-top { margin-left: 10px; margin-top: 8px; }
.scan-status { width: 350px; height: 25px; margin-top: 7px; padding-left: 9px; border-radius: 8px; background-color: @panel; flex-direction: row; align-items: center; }
