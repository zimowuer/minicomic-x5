...
.recent-column { width: 190px; height: 185px; }
.section-label { height: 22px; color: @muted; font-size: 11px; line-height: 17px; }
.recent-empty { width: 150px; height: 58px; padding: 18px 14px; border-radius: 13px; background-color: @panel; }
...
.mini-recent { width: 160px; height: 22px; margin-top: 8px; padding: 8px 10px; border-radius: 10px; background-color: @panel; flex-direction: row; justify-content: space-between; }
